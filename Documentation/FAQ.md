...
You might need to [verify your age](https://myaccount.google.com/age-verification) to receive the increased quotas. In addition, the following regions do not currently have access to upgraded quotas through Google One. This will be fixed soon.
...
Please see more details in the docs on [Plans](../docs/Plans.md).
